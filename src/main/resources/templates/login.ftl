<html>
<head>
    <title>用户登录-客户管理系统</title>
    <meta name="viewport" content="width=device-width">
    <link rel="stylesheet" type="text/css" href="${request.contextPath}/static/style/css/login.css?v=201612202107" />
    <script type="text/javascript" src="${request.contextPath}/static/js/jquery-1.11.1.min.js" charset="utf-8"></script>
    <script type="text/javascript" src="${request.contextPath}/static/js/login.js?v=20170115" charset="utf-8"></script>
    <script type="text/javascript" src="${request.contextPath}/static/scripts/boot.js"></script>
