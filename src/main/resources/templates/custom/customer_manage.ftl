...
>
    <div property="columns">
        ...
        <div field="tel" width="100" align="center" headerAlign="center">联系电话</div>
        <div field="fax" width="100" align="center" headerAlign="center">传真</div>
        <div name="level" field="level" width="100" align="center" headerAlign="center">客户等级</div>
        <div name="satify" field="satify" width="100" align="center" headerAlign="center">客户满意度</div>
        <div name="credit" field="credit" width="100" align="center" headerAlign="center">客户信用度</div>
        <div field="managerId" width="100" align="center" headerAlign="center" renderer="getManager">客户经理</div>
