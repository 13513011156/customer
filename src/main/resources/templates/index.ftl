...
<head>
    ...
    <script src="${request.contextPath}/static/scripts/miniui/miniui.js" type="text/javascript"></script>
    <link href="${request.contextPath}/static/scripts/miniui/themes/icons.css" rel="stylesheet" type="text/css"/>
    <link href="${request.contextPath}/static/scripts/miniui/themes/default/miniui.css" rel="stylesheet" type="text/css"/>
    <link href="${request.contextPath}/static/scripts/miniui/themes/jqueryui-smoothness/skin.css" rel="stylesheet" type="text/css"/>
...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
    <div class="header" region="north" height="76" showSplit="false" showHeader="false">
        <h1 style="margin:0;padding:21px;cursor:default;"><img src="${request.contextPath}/static/img/logo.png" style="width: 50px;height: 30px;margin-right: 2px;"/>客户关系管理系统</h1>
