...
>
    <div property="columns">
        ...
        <div name="method" field="method" width="100" align="center"  headerAlign="center">方法名</div>
        <div field="location" width="120" align="center" headerAlign="center">行+类名</div>
        <div field="msg" width="200" align="center" headerAlign="center">日志信息(登录名+【角色或密码】+状态)</div>
